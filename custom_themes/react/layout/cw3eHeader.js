...
const Cw3eHeader = ({ title }) => {
  return (
        <div id="masthead" class="site-header" role="banner">
            <div class="header-image" style="position: relative; max-width: 1320px;" >
                <a href="https://cw3e.ucsd.edu/" rel="home" style="width: 100%; justify-content: center;">
                    <img src="https://cw3e.ucsd.edu/wp-content/uploads/2024/08/header_finalv2.png" style="width: 100%;" srcset="https://cw3e.ucsd.edu/wp-content/uploads/2024/08/header_finalv2-300x32.png 300w, https://cw3e.ucsd.edu/wp-content/uploads/2024/08/header_finalv2-1024x110.png 1024w, https://cw3e.ucsd.edu/wp-content/uploads/2024/08/header_finalv2-768x83.png 768w, https://cw3e.ucsd.edu/wp-content/uploads/2024/08/header_finalv2.png 1200w" sizes="(max-width: 709px) 85vw, (max-width: 909px) 81vw, (max-width: 1362px) 88vw, 1200px" width="1200" height="129" alt="CW3E Header Logo"/>
                </a>
            </div>
            ...
            <div class="site-header-main">
                ...
                <div id="site-header-menu" class="site-header-menu" style="width: 100%;">
                    <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Primary Menu">
                                        <div class="menu-main-menu-container"><ul id="menu-main-menu" class="primary-menu"><li id="menu-item-25357" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-25357" aria-haspopup="true"><a href="https://cw3e.ucsd.edu/overview/">About</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
        <ul class="sub-menu">
            ...
            <li id="menu-item-25349" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-25349"><a href="https://cw3e.ucsd.edu/wp-content/uploads/CW3E_Strategic_Plan_2025.pdf">CW3E Strategic Plan</a></li>
        ...
        <li id="menu-item-25347" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-25347" aria-haspopup="true"><a href="#">Observations</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
        <ul class="sub-menu">
            <li id="menu-item-25356" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-25356" aria-haspopup="true"><a href="#">CW3E Observations</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
            <ul class="sub-menu">
        ...
        <li id="menu-item-25382" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-25382" aria-haspopup="true"><a href="https://cw3e.ucsd.edu/arrecon_overview/">AR Reconnaissance</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
        <ul class="sub-menu">
        ...
        <li id="menu-item-25367" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-25367" aria-haspopup="true"><a href="https://cw3e.ucsd.edu/iwv-and-ivt-forecasts/">Forecasts</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
        <ul class="sub-menu">
            ...
            <li id="menu-item-25353" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-25353" aria-haspopup="true"><a href="#">Deterministic Models</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
            <ul class="sub-menu">
            ...
            <li id="menu-item-25351" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-25351"><a href="https://cw3e.ucsd.edu/DSMaps/DS_intro.html">Interactive Maps</a></li>
            ...
            <li id="menu-item-25401" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-25401" aria-haspopup="true"><a href="https://cw3e.ucsd.edu/west-wrf/">West-WRF</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
            <ul class="sub-menu">
            ...
            <li id="menu-item-26184" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-26184" aria-haspopup="true"><a href="#">Forecast Verification</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
            <ul class="sub-menu">
        ...
        <li id="menu-item-25348" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-25348" aria-haspopup="true"><a href="/firo">FIRO</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
        <ul class="sub-menu">
            ...
            <li id="menu-item-25408" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-25408" aria-haspopup="true"><a href="https://cw3e.ucsd.edu/firo_projects/">Projects</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
            <ul class="sub-menu">
        ...
        <li id="menu-item-25350" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-25350" aria-haspopup="true"><a href="#">News &amp; Publications</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
        <ul class="sub-menu">
            ...
            <li id="menu-item-25375" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-25375" aria-haspopup="true"><a href="https://cw3e.ucsd.edu/publications/">Publications</a><button class="dropdown-toggle" aria-expanded="false"><span class="screen-reader-text">expand child menu</span></button>
            <ul class="sub-menu">
